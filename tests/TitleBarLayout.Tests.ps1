...
if ($embeddedIcon -notmatch 'LoadImageW\(\$module, \$groupIconId, \[NativeIcon\]::IMAGE_ICON, 64, 64, 0\)') {
    throw 'The embedded application icon loader must request a 64px taskbar icon.'
}
